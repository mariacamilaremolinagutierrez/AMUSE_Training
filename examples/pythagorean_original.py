...
if __name__ in ('__main__', '__plot__'):
  codes_to_run=[ ('Hermite0, $\eta=0.03$', Hermite,  [("dt_param",1)] ),
                 ('Hermite0, $\eta=0.01$', Hermite,  [("dt_param",0.1)] ),
  ...
  pyplot.savefig('pythagorean_original.png')
